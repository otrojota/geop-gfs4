    ...
    constructor(opciones) {
        ...
        Object.keys(config.variablesPorBanda).forEach(codGFS => {
            ...
            variableGFS.forEach(variable => {
                ...
                this.addCapa(new CapaRaster("noaa", variable.codigo, variable.nombre, "noaa", opciones, variable.grupos, variable.icono, variable.unidad, variable.niveles, variable.nivelInicial
                ))    
            })
        });
