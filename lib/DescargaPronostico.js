        ...
        try {
            ...
            for (let i=0; i<info.bands.length; i++) {
                ...
                if (variable) {
                    ...
                    if (variable.codigo == "TCDC_FULL") {
                        console.log("******** DBG: TDC_FULL ********************************************");
                        console.log("El archivo nuevo contiene TDC_FULL: " + fileName);
                    }
                }
            }
            ...
            if (existeAnterior) {
                ...
                for (let i=0; i<infoAnterior.bands.length; i++) {
                    ...
                    if (variable) {
                        if (!mapaImportadas[variable.codigo + "-" + nivel]) {
                            ...
                            if (variable.codigo == "TCDC_FULL") {
                                console.log("******** DBG: TDC_FULL ********************************************");
                                console.log("El archivo anterior existe y contiene TDC_FULL: " + outPath + "/" + outFileName);
                            }
                        }
                    }
                }
                if (bandasARescatar.length) {
                    try {
                        console.log("[rescata-anterior] Se encontraron bandas a rescatar en archivo anterior:" + bandasARescatar.length);
                        ...
                        console.log("[rescata-anterior] Bandas rescatadas en " + outFileName);
                    } catch(error) {
                        console.log("[rescata-anterior] Error agregando bandas de archivo anterior");
                        console.error(error);
                    }
                }
                try {
                    ...
                    console.error("No se puede eliminar archivo anterior: " + outPath + "/" + outFileName, error)
            ...
            //console.warn("No se borra el archivo origen ... modo prueba:" + fileName);
